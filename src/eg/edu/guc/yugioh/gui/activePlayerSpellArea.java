...
public class activePlayerSpellArea extends JPanel{
	private ArrayList<SpellButton> spells ;
	private BufferedImage image;
	public activePlayerSpellArea()  {
		super();
		spells = new ArrayList<SpellButton>();
		setSize(800,123);
		setLayout(new FlowLayout(FlowLayout.LEFT , 70 , 10));
		try{
			image = ImageIO.read(new File("E:/Semester 4/CSEN401/Yu-Gi-Oh/src/eg/edu/guc/yugioh/gui/apsa.png"));
		}catch(IOException e){
