...
public class opponentPlayerMonsterArea extends JPanel {
	private ArrayList<MonsterButton> monsters ;
	private BufferedImage image;
	public opponentPlayerMonsterArea() {
		super();
		monsters = new ArrayList<MonsterButton>();
		setSize(800,123);
		setLayout(new FlowLayout(FlowLayout.LEFT , 70 , 10));
		try{
			image = ImageIO.read(new File("E:/Semester 4/CSEN401/Yu-Gi-Oh/src/eg/edu/guc/yugioh/gui/opma.png"));
		}catch(IOException e){
